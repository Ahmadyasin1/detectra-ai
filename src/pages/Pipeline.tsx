...
export default function Pipeline() {
  return (
    <div className="min-h-screen bg-transparent">
      <PageHero
        badge="AI Pipeline · 9-Stage Design"
        badgeIcon={Video}
        title="Intelligence"
        titleAccent="Pipeline"
        description="Every frame of video passes through 9 specialized stages — from raw RTSP input to a complete multimodal intelligence report with natural-language scene understanding."
      />
              ...
              {STEPS.map((step, i) => (
                ...
                >
                  ...
                  <div className="relative flex-shrink-0 z-10">
                    ...
                    {/* Step number overlay */}
                    <span className="absolute -top-1.5 -right-1.5 w-5 h-5 rounded-full bg-transparent border border-white/20 flex items-center justify-center text-gray-400 font-mono text-xs font-bold">
                      {step.num}
                    </span>
                  </div>

                  {/* Card */}
                  <div className="flex-1 card-glass p-5 hover:border-white/20 transition-all duration-200 group">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              ...
              <div key={opt.title} className="card-glass p-5">
