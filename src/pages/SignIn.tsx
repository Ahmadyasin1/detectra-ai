...
export default function SignIn() {
  ...
  return (
    <>
      ...
      <div className="relative min-h-screen flex items-center justify-center px-4 py-12 pt-24 bg-transparent">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-600 focus:outline-none focus:border-cyan-500/60 focus:bg-gray-800 transition-colors text-sm"
                  />
                </div>
              </div>
