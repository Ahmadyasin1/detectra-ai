      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-20">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="card-glass overflow-hidden border-green-500/20"
              ...
              <ul className="p-4 space-y-0">
                {CAN_DO.map((item, i) => (
                  <motion.li
                    ...
                    className="flex items-start gap-2.5 py-2.5 border-b border-white/10/60 last:border-0"
                  >
            ...
            <motion.div
              ...
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
              className="card-glass overflow-hidden border-red-500/20"
          ...
          <div className="space-y-4">
            {RISKS.map((risk, i) => (
              <motion.div
                ...
                className="card-glass p-5 grid grid-cols-1 md:grid-cols-[180px_1fr_1fr] gap-4 items-start"
              >
                <div>
        ...
        <section>
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="card-glass p-6 border-blue-500/20"
          >
